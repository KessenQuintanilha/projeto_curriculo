...
export class AboutMe {
  ...
  titulo1= "Sobre Mim";
  titulo2 = `Desenvolvedora de Sistemas e Software Engineer Junior, com experiência em Gestão de
...
desenvolver soluções úteis que gerem impacto positivo para a empresa e seus usuários.`;
  ...
  titulo3="About me";
  titulo4= ` Systems Developer and Junior Software Engineer, with experience in Human Resources
